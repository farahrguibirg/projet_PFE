...
function EditGroupe() {
    ...
    const { id } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useParams"])(); // Récupération de l'ID du groupe
    ...
    console.log("ID du groupe récupéré:", id);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (id) {
            loadAllData();
        } else {
    ...
    const loadAllData = async ()=>{
        ...
        setError(null);
        try {
            console.log(`Requête envoyée à l'API : http://localhost:5000/api/getgroupe/${id}`);
            ...
            console.log("Réponse de l'API groupe:", groupeRes.data);
            const currentGroupe = groupeRes.data;
            setGroupe(currentGroupe);
            // Filtrer les tuteurs déjà affectés à d'autres groupes
            ...
            // Ajouter le tuteur actuel du groupe s'il en a un
            ...
            // Filtrer les sujets déjà affectés à 3 groupes maximum
            const sujetsCounts = {};
            ...
            const sujetsFiltered = sujetsRes.data.filter((sujet)=>{
                // Si c'est le sujet actuel du groupe, l'inclure
                if (currentGroupe.idSujet === sujet.idSujet) {
                    return true;
                }
                // Sinon, ne l'inclure que s'il est affecté à moins de 3 groupes
                return !sujetsCounts[sujet.idSujet] || sujetsCounts[sujet.idSujet] < 3;
            });
            setTuteurs(tuteursRes.data); // Tous les tuteurs (pour référence)
            setSujets(sujetsRes.data); // Tous les sujets (pour référence)
            setTuteursDisponibles(tuteursFiltered); // Tuteurs filtrés disponibles
            setSujetsDisponibles(sujetsFiltered); // Sujets filtrés disponibles
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                tuteurs.length !== tuteursDisponibles.length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: "Certains tuteurs ne sont pas affichés car ils sont déjà affectés à dautres groupes."
                                                }, void 0, false, {
                                                    fileName: "[project]/app/users/editgrp/[id]/page.js",
                                                    lineNumber: 199,
                                                    columnNumber: 19
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__73f384._.js.map