...
function Comptes() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:5000/api/loginc").then((response)=>{
            setUsers(response.data);
            setLoading(false);
        }).catch(()=>{
            setError("Erreur de chargement des comptes.");
            setLoading(false);
        });
    }, []);
    const filteredUsers = ()=>{
    ...
    const { sendEmail } = (()=>{
        const e = new Error("Cannot find module '../controllers/emailController'");
    ...
    const sendEmail = async (email, password)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5000/api/send-email", {
                email,
                subject: "Informations de Connexion à l'App",
                body: `Votre mot de passe est ${password}. Vous pouvez vous connecter en suivant ce lien: http://localhost:3000`
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6e3890._.js.map