...
const getYearOptions = ()=>{
    ...
    return [
        ...
        ...Array.from({
            length: 11
        }, (_, i)=>currentYear - 5 + i).map((year)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                value: year,
                children: year
            }, year, false, {
                fileName: "[project]/app/users/EditEncadrant/[id]/page.js",
...
function EditEncadrant() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        try {
            ...
            // If valid, fetch encadrant data if ID is provided
            if (id) {
                getEncadrant();
            } else {
    ...
    function getEncadrant() {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5000/api/getencadrant/${id}`).then(function(response) {
            ...
            setInputs({
                ...
                motDePasse: encadrantData.motDePasse,
                annee: encadrantData.annee,
                classe: encadrantData.classe,
                filiere: encadrantData.filiere
            });
            setIsLoading(false);
        }).catch((err)=>{
    ...
    const handleSubmit = (event)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/api/editencadrant/${id}`, inputs).then(function(response) {
            router.push('/encadrants'); // Redirect to encadrants list after update
        }).catch((err)=>{
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__220699._.js.map