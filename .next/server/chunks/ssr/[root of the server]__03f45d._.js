...
__turbopack_esm__({
    "YearFilterContext": (()=>YearFilterContext)
});
const YearFilterContext = {
    currentYear: new Date().getFullYear().toString(),
    setYear: (year)=>{
        // Stockez dans cookies/localStorage si nécessaire
        document.cookie = `yearFilter=${year}; path=/`;
    },
    getYear: ()=>{
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__03f45d._.js.map