...
function Edituser() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (id) {
            ...
            setError("L'identifiant de l'étudiant est manquant");
            setIsLoading(false);
        }
    }, [
        id
    ...
    function getUser() {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5000/api/getetudiant/${id}`).then(function(response) {
            const userData = response.data; // Utilisez response.data directement
            setInputs({
                nom: userData.nom,
            ...
            console.error("Erreur lors de la récupération de l'étudiant:", err);
            setError("Erreur lors de la récupération des données de l'étudiant.");
            setIsLoading(false);
        });
    }
    ...
    const handleSubmit = (event)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/api/editetudiant/${id}`, inputs).then(function(response) {
            ...
            console.error("Erreur lors de la mise à jour de l'étudiant:", err);
            setError("Erreur lors de la mise à jour de l'étudiant.");
        });
    };
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__680ba0._.js.map