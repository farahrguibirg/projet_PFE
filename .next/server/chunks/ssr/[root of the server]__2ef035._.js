...
(()=>{
    const e = new Error("Cannot find module '../components/ExportButton'");
...
function GestionGroupes() {
    ...
    const fetchData = async ()=>{
        ...
        try {
            ...
            const groupesData = processGroupesData(groupesResponse.data, etudiantsResponse.data, tuteursResponse.data, sujetsResponse.data);
            setGroupes(groupesData);
            setTuteurs(tuteursResponse.data);
            setSujets(sujetsResponse.data);
        } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2ef035._.js.map