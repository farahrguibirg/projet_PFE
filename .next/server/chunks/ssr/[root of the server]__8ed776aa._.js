...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$DataTableCompte$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/DataTableCompte.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function Comptes() {
    ...
    const filteredUsers = ()=>{
        return activeTab === "all" ? users : users.filter((user)=>user.role === activeTab);
    };
    ...
    const toggleSelectAll = (e)=>{
        ...
        if (e.target.checked) {
            const newSelectedUsers = Array.from(new Set([
                ...selectedUsers,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8ed776aa._.js.map