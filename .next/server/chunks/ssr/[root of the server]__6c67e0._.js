...
(()=>{
    const e = new Error("Cannot find module 'notistack'");
...
function EditGroupe() {
    ...
    const { idGroupe } = router.query; // ID du groupe depuis l'URL
    ...
    const fetchGroupeData = async ()=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5000/api/groupe/${idGroupe}`);
            setGroupe(response.data);
        } catch (error) {
            console.error("Erreur lors du chargement du groupe :", error);
            enqueueSnackbar('Erreur lors du chargement du groupe', {
                variant: 'error'
            });
        } finally{
            setLoading(false);
    ...
    const fetchTuteursSujets = async ()=>{
        try {
            const [tuteursResponse, sujetsResponse] = await Promise.all([
            ...
            console.error("Erreur lors du chargement des tuteurs et sujets :", error);
            enqueueSnackbar('Erreur lors du chargement des tuteurs et sujets', {
                variant: 'error'
            });
        }
    };
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!groupe.tuteur || !groupe.sujet) {
            enqueueSnackbar('Veuillez sélectionner un tuteur et un sujet.', {
                variant: 'warning'
            });
            return;
        }
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/api/groupe/${idGroupe}`, {
                tuteurId: groupe.tuteur.idTuteur,
                sujetId: groupe.sujet.idSujet
            });
            enqueueSnackbar('Groupe mis à jour avec succès', {
                variant: 'success'
            });
            router.push('/gestion-groupes'); // Retour à la page de gestion des groupes
        } catch (error) {
            console.error("Erreur lors de la mise à jour du groupe :", error);
            enqueueSnackbar('Erreur lors de la mise à jour du groupe', {
                variant: 'error'
            });
        }
    };
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$FormControl$2f$FormControl$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__FormControl$3e$__["FormControl"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$Select$2f$Select$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Select$3e$__["Select"], {
                                ...
                                onChange: (e)=>setGroupe({
                                        ...groupe,
                                        sujet: sujets.find((s)=>s.idSujet === e.target.value)
                                    }),
                                label: "Sujet",
                                children: sujets.map((sujet)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$MenuItem$2f$MenuItem$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MenuItem$3e$__["MenuItem"], {
                                        value: sujet.idSujet,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6c67e0._.js.map