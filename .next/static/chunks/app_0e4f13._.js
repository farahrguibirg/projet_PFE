(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_0e4f13._.js", {
...
function Edituser() {
    ...
    // États
    const [etudiant, setEtudiant] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const loadAllData = async ()=>{
        ...
        try {
            const [etudiantRes, groupesRes, tuteursRes, sujetsRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5000/api/getetudiant/${id}`),
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/api/modifierGroupe/${id}`, {
...
_s(Edituser, "8XAOSHcW59x6nKmnwnjB3B+1k7g=", false, function() {
    return [
...
//# sourceMappingURL=app_0e4f13._.js.map