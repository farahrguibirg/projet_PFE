(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_001494._.js", {
...
"[project]/app/users/readEtu/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ListUser() {
    _s();
    const [etudiants, setUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const getUsers = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:5000/api/etudiants');
    ...
    const deleteUser = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:5000/api/deleteetudiant/${id}`);
            getUsers();
        } catch (err) {
    ...
    const handleUpload = async (file)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5000/api/import-data', formData, {
                headers: {
...
_s(ListUser, "eZUJoWEWZvq1Lb8PneKEwW4b5r0=");
_c = ListUser;
var _c;
...
"[project]/app/users/readEtu/page.js [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=app_001494._.js.map