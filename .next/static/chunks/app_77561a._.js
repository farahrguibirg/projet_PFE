(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_77561a._.js", {
...
"[project]/app/users/readEnca/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ListEncadrant() {
    _s();
    const [encadrants, setEncadrants] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const getEncadrants = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:5000/api/Encadrants');
    ...
    const deleteEncadrant = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:5000/api/deleteEncadrant/${id}`);
            getEncadrants();
        } catch (err) {
    ...
    const handleUpload = async (file)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5000/api/import-Encadrant', formData, {
                headers: {
...
_s(ListEncadrant, "yfc01ZPhsMATCL/6SUmt8GxQgVI=", false, function() {
    return [
...
_c = ListEncadrant;
var _c;
__turbopack_refresh__.register(_c, "ListEncadrant");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/app/users/readEnca/page.js [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=app_77561a._.js.map