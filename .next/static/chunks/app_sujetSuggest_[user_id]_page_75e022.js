(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_sujetSuggest_[user_id]_page_75e022.js", {
...
function ProposerSujet() {
    ...
    const handleSubmitSujet = async ()=>{
        ...
        try {
            ...
            setTimeout(()=>{
                router.push(`/encadrants/${user_id}`);
            }, 1500);
        } catch (err) {
            setSubmitMessage({
                type: 'error',
...
//# sourceMappingURL=app_sujetSuggest_%5Buser_id%5D_page_75e022.js.map