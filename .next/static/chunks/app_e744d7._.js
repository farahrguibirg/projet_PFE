(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_e744d7._.js", {
...
"[project]/app/users/editEnca/[id]/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EditEncadrant() {
    ...
    const getUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EditEncadrant.useCallback[getUser]": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5000/api/getEncadrant/${id}`).then({
                "EditEncadrant.useCallback[getUser]": function(response) {
            ...
            }["EditEncadrant.useCallback[getUser]"]).catch({
                "EditEncadrant.useCallback[getUser]": (err)=>{
    ...
    const handleSubmit = (event)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/api/editEncadrant/${id}`, inputs).then(function() {
...
_s(EditEncadrant, "6ZowrM5IvaiDWPe1eSgj418kVTo=", false, function() {
    return [
...
_c = EditEncadrant;
var _c;
__turbopack_refresh__.register(_c, "EditEncadrant");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/app/users/editEnca/[id]/page.js [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=app_e744d7._.js.map