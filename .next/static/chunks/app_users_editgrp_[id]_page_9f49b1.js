(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_users_editgrp_[id]_page_9f49b1.js", {
...
function EditGroupe() {
    ...
    const fetchGroupeData = async ()=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5000/api/groupe/${idGroupe}`);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/api/groupe/${idGroupe}`, {
...
_s(EditGroupe, "+YrS4WrClG3mcvpPeQId47PcTdE=", false, function() {
    return [
...
//# sourceMappingURL=app_users_editgrp_%5Bid%5D_page_9f49b1.js.map