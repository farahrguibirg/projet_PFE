...
export default function Edituser() {
  ...
  function getUser() {
    axios.get(`http://localhost:5000/api/getetudiant/${id}`)
  ...
  const handleSubmit = (event) => {
    ...
    axios.put(`http://localhost:5000/api/editetudiant/${id}`, inputs)
      .then(function(response) {
  ...
  return (
    <Layout>
      <div className="form-container w-full max-w-2xl">
        ...
        <h1 className="form-title">Modifier l'Étudiant</h1>
