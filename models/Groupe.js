...
Groupe.hasMany(Etudiant, {
  foreignKey: 'idGroupe',
  as: 'etudiants',  // Alias unique pour éviter les conflits
});

// Relation un-à-un entre Groupe et Tuteur
Groupe.belongsTo(Tuteur, {
  foreignKey: 'idTuteur',
  as: 'tuteur',  // Alias unique pour éviter le conflit
});

// Relation un Sujet peut avoir plusieurs Groupes
Sujet.hasMany(Groupe, {
  foreignKey: 'idSujet',
  as: 'groupe',
});
...
Groupe.belongsTo(Sujet, {
  foreignKey: 'idSujet',
  as: 'sujet',  // Alias unique pour éviter les conflits
});
